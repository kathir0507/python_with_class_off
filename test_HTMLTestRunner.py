...
from Testcases import Test_Cron2_PopulateForecastDate, Test_Cron3_PerformAupUpgradeSiteCreation, Test_Cron4_PerformCruxAndCXIntegration
from Testcases import Test_Cron1_AupPreferences
...
class Test_HTMLTestRunner(unittest.TestCase):
    ...
    def test_main(self):
        ...
        self.suite = unittest.TestSuite()
        self.suite.addTests([
            #unittest.defaultTestLoader.loadTestsFromTestCase(Test_Addsite.Test_Addsite)
        unittest.defaultTestLoader.loadTestsFromTestCase(Test_Cron1_PopulateFoTest_Cron1_AupPreferencesorecaseDate),
        unittest.defaultTestLoader.loadTestsFromTestCase(Test_Cron2_PopulateForecastDate.Test_Cron2_PopulateForecaseDate),
        unittest.defaultTestLoader.loadTestsFromTestCase(Test_Cron3_PerformAupUpgradeSiteCreation.Test_Cron3_PerformAupUpgradeSiteCreation),
        unittest.defaultTestLoader.loadTestsFromTestCase(Test_Cron4_PerformCruxAndCXIntegration.Test_Cron4_CruxCxRestIntegration_cron4)
                  ])
        ...
        runner = HTMLTestRunner.HTMLTestRunner(
                    stream=buf,
                    title='..::.. CruxAutomation Test ..::..',
                    description='This is the Report after running TestSuite'
                    )
        runner.run(self.suite)
